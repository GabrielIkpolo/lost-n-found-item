...
//       // --- Routes WITH sidebar wrapped by MainLayout ---
//       {
//         element: <MainLayout />,
//         children: [
//           { path: '/', element: <Home /> },
...
//       // Support detail and create pages (can be outside the main layout if desired)
//       { path: 'support/new', element: <ProtectedRoutes><CreateTicketPage /></ProtectedRoutes> },
//       { path: 'support/:id', element: <ProtectedRoutes><TicketDetailPage /></ProtectedRoutes> },
